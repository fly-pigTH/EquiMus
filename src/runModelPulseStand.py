...
# 加载stand实验数据
MAAP = scipy.io.loadmat('./src/F1_array_landing2DOF_stand.mat').get("F1_matrix").flatten() # new data
BAAP = scipy.io.loadmat('./src/F2_array_landing2DOF_stand.mat').get("F2_matrix").flatten()
print(MAAP.shape)
